...
- If the user takes over a resource, stop the affected operation; do not try to reclaim control.
- Prefer short unordered-list items than large paragraph.
- Reference files with URI format and relevant line numbers.
